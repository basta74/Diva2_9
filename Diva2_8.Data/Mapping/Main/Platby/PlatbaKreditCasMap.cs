...
{
    class PlatbaKreditCasMap : IEntityTypeConfiguration<PlatbaKreditCas>
    {

        public void Configure(EntityTypeBuilder<PlatbaKreditCas> builder)
        {
            ...
            builder.Property(d => d.PocetMesicu).HasColumnName("verze");
            ...
            builder.Property(d => d.Ts).HasColumnName("unix");


            builder.ToTable("spin_platba_kredit_cas");
        }
    }
}